...
public class DTOBuddy {
    ...
    public static Class<?> createDynamicClass(MethodInterceptor interceptor) throws ReflectiveOperationException {
        ...
        TypeDeclaration<?> dtoType = cu == null ? null : AbstractCompiler.getMatchingType(cu, eval.getClassName()).orElseThrow();
        String className = cu == null ? eval.getClassName() : dtoType.getNameAsString();
    ...
    public static boolean isByteBuddyClass(Class<?> clazz) {
