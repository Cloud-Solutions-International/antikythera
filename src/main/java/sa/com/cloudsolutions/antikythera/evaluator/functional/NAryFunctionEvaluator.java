...
/**
 * Evaluator for n-ary (3+ parameter) lambdas that return a value.
 * Java has no standard functional interface beyond BiFunction, so this evaluator
 ...
 */
public class NAryFunctionEvaluator extends FPEvaluator<Object> {

    public NAryFunctionEvaluator(EvaluatorFactory.Context context) {
        super(context);
